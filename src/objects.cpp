...
pros::Motor drvLF {motors::drvLF, motors::cart::E_MOTOR_GEARSET_18, true, motors::enc::E_MOTOR_ENCODER_COUNTS};
...
pros::Motor drvRF {motors::drvRF, motors::cart::E_MOTOR_GEARSET_18, false, motors::enc::E_MOTOR_ENCODER_COUNTS};

// -- Others -- //

pros::Motor convyMot    {motors::convyPort, motors::cart::E_MOTOR_GEARSET_06, true, motors::enc::E_MOTOR_ENCODER_COUNTS};
pros::Motor intkMot     {motors::intkPort, motors::cart::E_MOTOR_GEARSET_36, true, motors::enc::E_MOTOR_ENCODER_COUNTS};
...
/* This function is to help control both the intake and conveyor
 * motors at the same time for the sake of easier coding.
 * \param intake
 *      Sets the power to the intake motor.
 *  \param convy
 *      Sets the power to the conveyor motor.
 */
auto Set_Intk_Convy(int intake, int convy) -> void
{
    intkMot.move_velocity(intake);
    convyMot.move_velocity(convy);
}